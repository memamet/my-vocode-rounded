...
const VocodeApp: React.FC<VocodeAppProps> = ({
  defaultBackendUrl,
  isInputEditable,
}) => {
    ...
    <main>
      ...
      <div className="flex w-full max-w-sm items-center space-x-2">
        {isInputEditable && (
          <div className="grid w-full max-w-sm items-center gap-1.5">
            ...
            <Label htmlFor="backend-url" className="backendUrlLabel">
              Backend
            </Label>
      ...
      {isInputEditable && (
        <div className="statusBox">
          {status === "idle" && (
            <p className="idleMessage">Press the mic to talk!</p>
          )}
          {status === "error" && error && (
      ...
      <div className="flex justify-center items-center">
        <PingComponent
          backendUrl={backendPingUrl}
          setIsOnline={setIsBackendOnline}
        />
      </div>
      <div className="flex" style={{ width: "400px" }}>
        {analyserNodeRef.current && (
          <div className="w-1/2">
            <AudioVisualizer analyserNode={analyserNodeRef.current} />
          </div>
        )}
        {analyserNode && (
          <div className="w-1/2">
